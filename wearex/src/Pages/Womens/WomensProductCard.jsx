...
function WomensProductCard({id,image,title,price,category,discount,lineThroughPrice}) {
  return (
   <Box
   ...
   >
    <RouterLink to={`/womensproduct/${id}`}>
      ...
      <Box fontFamily={'unset'} >
        <Text mt={2} fontWeight={'semibold'} fontSize={{base:'15px',sm:'15px'}} color='#D5A249'>{category}</Text>
